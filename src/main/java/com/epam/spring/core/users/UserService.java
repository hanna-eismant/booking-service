...
public interface UserService {
     ...
     *
     * @param name
     *            user name. Cannot be {@code null} or empty. Should be unique.
     * @param email
     *            user e-mail. Cannot be {@code null} or empty. Should be unique.
     * @param password
     *            user password. Cannot be {@code null} or empty.
     * @param birthday
     *            user birthday. Cannot be {@code null} or in future.
     * @return registered user.
     * @throws DuplicateException
     *             if user with passed email or name already registered.
     * @throws IllegalArgumentException
     *             if any passed parameters are incorrect.
     */
    User register(String name, String email, String password, LocalDate birthday) throws IllegalArgumentException, DuplicateException;
     ...
     *             if user with with specific ID doesn't exist.
     */
     ...
     * @return found user.
     * @throws IllegalArgumentException
     *             if passed email is {@code null} or empty.
     * @throws NotFoundException
     *             if user with with specific email doesn't exist.
     */
     ...
     * @return found user.
     * @throws IllegalArgumentException
     *             if passed name is {@code null} or empty.
     * @throws NotFoundException
     *             if user with with specific name doesn't exist.
     */
