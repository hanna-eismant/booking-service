...
public abstract class AbstractPdfView extends AbstractView {
    ...
    protected Font headerFont = FontFactory.getFont("Arial Black", 18, Font.NORMAL, new BaseColor(57, 194, 215));
    protected Font tableHeaderFont = FontFactory.getFont("Trebuchet MS", 10, Font.BOLD, new BaseColor(70, 69, 71));
    protected Font textFont = FontFactory.getFont("Trebuchet MS", 10, Font.NORMAL, new BaseColor(70, 69, 71));
